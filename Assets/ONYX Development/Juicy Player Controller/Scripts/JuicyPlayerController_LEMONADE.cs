...
namespace ONYX {
    public class JuicyPlayerController_LEMONADE : MonoBehaviour {
        [HideInInspector] public static JuicyPlayerController_LEMONADE instance;
        ...
        [SerializeField] private Transform graphics_container;
        ...
        private void DoGraphicsRotation(){
            if (move_input.x != 0f || move_input.y != 0f) {
                Vector3 inputDirection = new Vector3(move_input.x, 0f, move_input.y).normalized;
